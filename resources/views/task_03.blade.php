            ...
            @if (isset($backend_url))
                <form action="{{ route($backend_url) }}" method="GET" class="form-inline mt-3">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="number" name="radio" class="form-control" step="any"
                            placeholder="Ingrese el radio de la circunferencia a calcular">
                    </div>
                    <div class="form-group mx-sm-3 mb-2 w-100 ">
                        <button type="submit" class="btn btn-primary mb-2 w-25">Calcular</button>
                    </div>
                </form>
            @endif
            @if (isset($reload))
