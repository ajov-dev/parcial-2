        ...
        <div class="card">
            ...
            @if (isset($backend_url))
                <form action="{{ route($backend_url) }}" method="POST" class="form-inline mt-3">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="number" name="nota_04" class="form-control" step="any"
                            placeholder="Ingrese la nota 04">
                    </div>
                    <div class="form-group mx-sm-3 mb-2">
                        <input type="number" name="nota_05" class="form-control" step="any"
                            placeholder="Ingrese la nota 05">
                    </div>
